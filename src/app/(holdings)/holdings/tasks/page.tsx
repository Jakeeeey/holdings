...
import { TaskBoard } from "@/modules/holdings/tasks/components/TaskBoard";
...
function getUserIdFromToken(token: string | null | undefined): string | number {
    const payload = token ? decodeJwtPayload(token) : null;
    if (payload) {
        return (payload.id || payload.userId || payload.user_id || payload.sub) as string | number;
    }
    return "";
}
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Holdings</BreadcrumbLink>
                                </BreadcrumbItem>
